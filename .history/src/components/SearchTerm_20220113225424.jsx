...
export const MainPage = () => {
  ...
  useEffect(() => {
    axios({
      ...
      headers: {
        Authorization: `Bearer eyJqJSFcp44uMVCA9sSk8jQu9IhkTTxf8wZNNgYqKILubms3fqzEcfym2bpc1zI3MnZd0LozalYzHRGmtiEMOnGDrIswaoHBmJmxjQ1V98McC8A699IGaPY1u9FaQNvQvAKg3D2JWP56WSOz10GK-g9LW8px5Mht9AlcdBDUWF8s70oevM`,
      },
    }).then((res) => {
      setPosts(res.data);
